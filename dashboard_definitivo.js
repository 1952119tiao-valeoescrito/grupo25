    ...
    <div className="min-h-screen bg-[#010409] text-white font-sans overflow-x-hidden relative selection:bg-cyan-500/30">
      ...
      <header className="sticky top-0 z-50 bg-[#020617]/90 backdrop-blur-md border-b border-white/10 h-20 flex items-center px-6">
        <div className="max-w-[1200px] mx-auto w-full flex justify-between items-center">
          ...
          <div className="flex items-center gap-4">
             <span className="text-[10px] font-black text-yellow-500 border border-yellow-500/20 px-3 py-1 rounded-full uppercase">Acesso Restrito</span>
          </div>
        </div>
      </header>
      ...
      <main className="max-w-[1100px] mx-auto px-4 md:px-6 py-10 text-center relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12 max-w-5xl mx-auto">
          <div className="bg-[#0f172a]/95 border border-cyan-500/30 p-10 rounded-[3rem] shadow-2xl text-center">
             ...
             <button className="w-full bg-cyan-500 text-black py-4 rounded-3xl font-black text-[10px]">Acessar Site</button>
          </div>
          <div className="bg-[#0f172a]/95 border border-cyan-500/30 p-10 rounded-[3rem] shadow-2xl text-center">
        ...
        <div className="grid lg:grid-cols-3 gap-8 items-start text-left">
          ...
          <div className="lg:col-span-2 bg-[#0d1117] border border-cyan-500/30 p-6 md:p-10 rounded-[3rem] shadow-2xl">
             ...
             <div className="flex gap-4 max-w-md mx-auto">
                ...
                <button onClick={()=>{}} className="flex-1 bg-[#ea580c] p-4 rounded-2xl font-black text-[10px] uppercase shadow-lg">Confirmar Certificado</button>
             </div>
        ...
        <footer className="py-20 border-t border-white/5 opacity-30 text-center">
           <p onClick={()=>{setClickCount(c=>c+1); if(clickCount>=4) window.location.href='/admin/central'}} className="text-[10px] font-black uppercase tracking-[0.5em] italic cursor-pointer select-none">
...
console.log("✅ Dashboard Blindado, Nítido e com a Hierarquia Correta!");
