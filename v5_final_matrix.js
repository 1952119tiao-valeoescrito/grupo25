      ...
      <main className="max-w-6xl mx-auto px-4 md:px-6 py-10 text-center relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-16 max-w-5xl mx-auto">
            ...
            <div className="bg-[#0f172a]/90 border border-cyan-500/30 p-10 rounded-[3.5rem] shadow-2xl flex flex-col items-center justify-center">
               ...
               <button className="w-full bg-slate-800 p-4 rounded-xl font-black text-[10px] uppercase border border-white/5">Gerar Pix</button>
            </div>
        </div>
        ...
        {/* 4. BLOCO INFERIOR: MALHA + COLUNA DIREITA */}
        <div className="grid lg:grid-cols-3 gap-8 items-start text-left mb-20">
          <div className="lg:col-span-2 bg-[#0d1117] border border-cyan-500/30 p-6 md:p-10 rounded-[3rem] shadow-2xl">
             ...
             <div className="flex gap-4 max-w-md mx-auto">
                <button onClick={gerarMalha} className="flex-1 bg-slate-800 p-4 rounded-2xl font-black text-[10px] uppercase border border-white/5">Trocar Coordenadas</button>
          ...
          <div className="space-y-6">
            <div className="bg-[#0f172a] border border-amber-500/30 p-10 rounded-[2.5rem] shadow-2xl relative overflow-hidden">
...
console.log("💎 DASHBOARD PIXEL-PERFECT FINALIZADO COM SUCESSO!");
