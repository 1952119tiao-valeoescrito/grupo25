  ...
  return (
    <div className="min-h-screen bg-[#030712] flex flex-col items-center justify-center p-4 md:p-10 text-slate-200 font-sans print:bg-white print:p-0">
      <div className="bg-slate-900/90 border-2 border-cyan-500/30 w-full max-w-4xl rounded-[3rem] p-8 md:p-16 shadow-2xl relative overflow-hidden print:bg-white print:text-black print:shadow-none print:border-black">
        ...
        <div className="absolute top-10 right-10 border-4 border-emerald-500/40 text-emerald-500/40 px-6 py-2 rounded-xl font-black uppercase text-xl rotate-[-15deg] print:border-black print:text-black z-0">
          Autenticado
        </div>

        <header className="flex flex-col md:flex-row justify-between items-center border-b border-cyan-900/30 pb-8 mb-8 gap-6 print:border-black relative z-10">
        ...
        <section className="grid md:grid-cols-2 gap-10 mb-10 relative z-10">
            <div className="space-y-6">
                <div>
                  <p className="text-[9px] text-slate-500 font-black uppercase mb-1">ID do Bilhete</p>
                  <p className="font-mono font-bold text-white print:text-black">#{data.id}</p>
                </div>
                
                <div>
                  <p className="text-[9px] text-slate-500 font-black uppercase mb-1">Apostador</p>
                  <p className="font-bold text-white print:text-black uppercase text-lg">{data.usuario}</p>
                </div>
                ...
                <div className="mt-8">
                   <h3 className="text-[10px] font-black text-cyan-500 uppercase tracking-widest mb-6 italic print:text-black border-l-2 border-cyan-500 pl-3">Sua Malha Matrix 5x5</h3>
                   <div className="flex flex-col gap-2">
                      {[0,1,2,3,4].map((i) => (
                        <div key={i} className="flex items-center gap-3">
                          <span className="text-[8px] font-black text-slate-500 uppercase w-16 text-right">{i+1}º Prêmio:</span>
