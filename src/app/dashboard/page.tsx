...
export default function DashboardShowroom() {
  ...
  return (
    <div className="min-h-screen bg-[#010409] text-white font-sans overflow-x-hidden relative selection:bg-cyan-500/30">
      ...
      {/* HEADER SHOWROOM COM LOGO OFICIAL */}
  ...
  <div className="max-w-7xl mx-auto w-full flex justify-between items-center">
    ...
    <div className="flex items-center gap-6">
       <div className="hidden md:flex gap-4">
          ...
          <button onClick={()=>router.push('/resultados')} className="text-[10px] font-black uppercase text-white hover:text-cyan-400 transition-all">Resultados</button>
       </div>
       <div className="bg-yellow-500/10 px-4 py-2 rounded-full border border-yellow-500/20">
          <p className="text-[10px] font-bold text-yellow-500 uppercase">Olá, {user.nome.split(' ')[0]}</p>
       </div>
