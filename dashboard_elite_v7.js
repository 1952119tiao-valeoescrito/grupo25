    ...
    <div className="min-h-screen bg-[#010409] text-white font-sans overflow-x-hidden relative selection:bg-cyan-500/30">
      ...
      <header className="sticky top-0 z-50 bg-[#020617]/90 backdrop-blur-md border-b border-white/10 h-20 flex items-center px-6">
        <div className="max-w-[1200px] mx-auto w-full flex justify-between items-center font-elite">
          ...
          <div className="flex items-center gap-4">
             <span className="text-[9px] font-black text-yellow-500 border border-yellow-500/20 px-3 py-1 rounded-full uppercase">Acesso Restrito</span>
             <button onClick={()=>{localStorage.clear(); window.location.href='/';}} className="bg-slate-800 p-1.5 rounded-lg border border-white/10"><LogOut size={14}/></button>
          </div>
        </div>
      </header>
      ...
      <main className="max-w-6xl mx-auto px-4 md:px-6 py-10 text-center relative z-10">
        ...
        <section className="mb-10">
          ...
          <p className="text-[9px] text-yellow-500 font-bold uppercase tracking-widest italic font-elite">Sábado às 20:00hrs</p>
        </section>

        {/* --- MALHA MATRIX E SIDEBAR --- */}
        <div className="grid lg:grid-cols-3 gap-8 items-start text-left mb-20">
          <div className="lg:col-span-2 bg-[#0d1117] border border-cyan-500/30 p-6 md:p-10 rounded-[3rem] shadow-2xl">
             <h2 className="text-yellow-500 font-black text-[10px] uppercase mb-8 tracking-widest text-center italic font-elite">Sua Malha de Coordenadas Matrix 5x5</h2>
             ...
             <div className="flex gap-4 max-w-md mx-auto">
                ...
                <button onClick={handleConfirmar} className="flex-1 bg-[#ea580c] p-4 rounded-2xl font-black text-[10px] uppercase shadow-lg font-elite transition-all hover:bg-orange-500">Confirmar Certificado</button>
             </div>
        ...
        {/* --- NOVO BLOCO OPERACIONAL: LOGIN E PIX --- */}
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-16 max-w-5xl mx-auto">
            <div className="bg-[#0f172a] border border-cyan-500/30 p-10 rounded-[3.5rem] shadow-2xl text-left">
            ...
            <div className="bg-[#0f172a] border border-cyan-500/30 p-10 rounded-[3.5rem] shadow-2xl flex flex-col items-center justify-center">
               <h3 className="text-[11px] text-cyan-400 mb-8 uppercase font-black font-elite">02. CRÉDITO (R$ 10)</h3>
               <div className="bg-white p-4 rounded-3xl mb-8 shadow-inner">
               ...
               <button onClick={handleConfirmar} className="w-full bg-slate-800 p-4 rounded-xl text-white font-black text-[10px] uppercase border border-white/5">Gerar Pix</button>
            </div>
        </div>
        ...
        <section className="mb-20">
           ...
           <p className="text-cyan-400 font-bold uppercase tracking-[0.4em] text-[10px] font-elite">Nossa produção 100% blockchain</p>
        </section>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10 mb-20 max-w-5xl mx-auto px-4">
          <div className="bg-[#0f172a] border border-cyan-500/20 p-10 rounded-[3rem] shadow-2xl text-center">
             <h3 className="text-xl text-yellow-500 mb-2 font-black uppercase font-elite tracking-widest italic">INTER-BET</h3>
             <p className="text-[10px] text-slate-400 uppercase font-bold mb-8">Ganha com até 1 ponto</p>
             <button className="inline-block w-full py-5 bg-cyan-500 text-black rounded-[2rem] font-black uppercase text-xs transition-all hover:scale-105">Acessar Site</button>
          </div>
          <div className="bg-[#0f172a] border border-cyan-500/20 p-10 rounded-[3rem] shadow-2xl text-center">
             <h3 className="text-xl text-cyan-400 mb-2 font-black uppercase font-elite tracking-widest italic">QUINA-BET</h3>
             <p className="text-[10px] text-slate-400 uppercase font-bold mb-8">Sorteios Semanais</p>
             <button className="inline-block w-full py-5 bg-cyan-500 text-black rounded-[2rem] font-black uppercase text-xs transition-all hover:scale-105">Acessar Site</button>
          </div>
        </div>

        {/* --- RODAPÉ FINAL: CONTATO E COPYRIGHT --- */}
        <div className="bg-[#0d1117]/70 border border-cyan-500/20 p-10 md:p-12 rounded-[4rem] mb-12 max-w-4xl mx-auto shadow-2xl backdrop-blur-md">
           ...
           <div className="grid md:grid-cols-2 gap-10 text-center">
              <div><p className="text-[11px] text-slate-500 uppercase font-black mb-2 text-center font-elite">E-mail Suporte</p><p className="text-sm font-bold text-center">suporte@blockchain-betbrasil.io</p></div>
              <div><p className="text-[11px] text-slate-500 uppercase font-black mb-2 text-center font-elite">WhatsApp Oficial</p><p className="text-sm font-bold text-center">+55 (21) 99352-7957</p></div>
           </div>
        </div>
      ...
      <div onClick={()=>router.push('/como-funciona')} className="fixed bottom-6 right-6 w-14 h-14 bg-cyan-600 rounded-full flex items-center justify-center shadow-[0_0_20px_rgba(6,182,212,0.5)] cursor-pointer hover:scale-110 transition-all z-[300] text-white">
         <HelpCircle size={28} />
      </div>
...
"@
Set-Content -Path "src/app/dashboard/page.tsx" -Value $code -Encoding UTF8
Write-Host "✅ DASHBOARD FINALIZADO 100%! Layout oficial restaurado e unificado." -ForegroundColor Cyan