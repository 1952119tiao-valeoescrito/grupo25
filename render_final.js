...
import { Trophy, RefreshCw, ChevronRight, Loader2, LogOut, Wallet, Scale, HelpCircle, LayoutDashboard } from 'lucide-react';
      ...
      <main className="max-w-6xl mx-auto px-4 md:px-6 py-10 text-center relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12 max-w-5xl mx-auto">
          <div className="bg-[#0f172a]/95 border border-cyan-500/30 p-10 rounded-[3.5rem] shadow-2xl text-center backdrop-blur-md">
             ...
             <button className="w-full bg-cyan-500 text-black py-4 rounded-3xl font-black text-[10px] uppercase shadow-lg">Acessar Site</button>
          </div>
          <div className="bg-[#0f172a]/95 border border-cyan-500/30 p-10 rounded-[3.5rem] shadow-2xl text-center backdrop-blur-md">
        ...
        {/* 4. BLOCO FINAL: MALHA + COLUNA DIREITA */}
        <div className="grid lg:grid-cols-3 gap-8 items-start text-left mb-20">
          ...
          <div className="lg:col-span-2 bg-[#0d1117] border border-cyan-500/30 p-6 md:p-10 rounded-[3.5rem] shadow-2xl">
             ...
             <div className="flex gap-4 max-w-md mx-auto">
                ...
                <button onClick={handleConfirmar} disabled={loading} className="flex-1 bg-[#ea580c] p-4 rounded-2xl font-black text-[10px] uppercase shadow-lg font-elite transition-all hover:bg-orange-500">Confirmar Certificado</button>
             </div>
        ...
        <div className="bg-[#0d1117]/70 border border-cyan-500/20 p-10 md:p-12 rounded-[4rem] mb-12 max-w-4xl mx-auto shadow-2xl backdrop-blur-md">
           ...
           <div className="grid md:grid-cols-2 gap-10 text-center">
              <div><p className="text-[11px] text-slate-500 uppercase font-black mb-2 text-center">E-mail Suporte</p><p className="text-sm font-bold text-center text-white italic">suporte@blockchain-betbrasil.io</p></div>
              <div><p className="text-[11px] text-slate-500 uppercase font-black mb-2 text-center">WhatsApp Oficial</p><p className="text-sm font-bold text-center text-white italic">+55 (21) 99352-7957</p></div>
           </div>
        </div>
