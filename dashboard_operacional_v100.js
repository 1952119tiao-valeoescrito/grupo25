...
export default function DashboardOperacional() {
  ...
  const [timer, setTimer] = useState("05:03:02:04");
    ...
    <div className="min-h-screen bg-[#010409] text-white font-sans overflow-x-hidden relative selection:bg-cyan-500/30">
      ...
      <div className="w-full bg-black border-b border-cyan-500/30 py-3 overflow-hidden h-[45px] z-50 relative flex items-center">
        <div className="animate-marquee whitespace-nowrap text-cyan-400 font-black uppercase text-[11px] tracking-widest font-elite">
           🚀 BEM-VINDO À MIMOSINHA BRASIL: REALIZE APOSTAS GRATUITAMENTE NO MODO TREINO PARA ENTENDER COMO FUNCIONA NA PRÁTICA! &nbsp;&nbsp;&nbsp; | &nbsp;&nbsp;&nbsp; 💸 NO MODO REAL O PAGAMENTO DA PREMIAÇÃO É AUTOMÁTICO VIA PIX
        </div>
      </div>
      ...
      <main className="max-w-6xl mx-auto px-4 md:px-6 py-10 text-center relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-16 max-w-5xl mx-auto items-stretch">
            <div className="bg-[#0f172a]/95 border border-cyan-500/30 p-10 rounded-[3.5rem] shadow-2xl text-left">
               ...
               <div className="space-y-4">
                  ...
                  <button onClick={()=>alert("Acesso Validado")} className="w-full bg-cyan-700 p-5 rounded-2xl font-black text-xs uppercase shadow-lg">ACESSAR MATRIX</button>
               </div>
            </div>

            <div className="bg-[#0f172a]/95 border border-cyan-500/30 p-10 rounded-[3.5rem] shadow-2xl flex flex-col items-center justify-center">
        ...
        <section className="mb-20">
           <h2 className="text-xl md:text-4xl font-black uppercase tracking-tighter text-white font-elite">
        ...
        <div className="grid lg:grid-cols-3 gap-8 items-start text-left mb-20">
          ...
          <div className="space-y-6">
            ...
            <div className="bg-[#0d1117] border border-white/10 p-8 rounded-[2.5rem] shadow-2xl text-[9px] font-bold text-slate-400 uppercase">
               <h3 className="text-yellow-500 mb-6 uppercase font-bold text-[10px] tracking-widest font-elite">⚖️ Transparência Legal</h3>
               <div className="space-y-4">
...
console.log("✅ Dashboard Finalizado! Botões ativados e textos reorganizados.");