  ...
  return (
    <div className="min-h-screen bg-[#010409] text-white font-sans overflow-x-hidden relative selection:bg-cyan-500/30">
      ...
      <main className="max-w-[1100px] mx-auto px-4 md:px-6 py-10 text-center relative z-10">
        ...
        {/* --- GRID 2 COLUNAS (LAYOUT DO PRINT 2) --- */}
        ...
        {/* --- RODAPÉ: SLOGAN E PRODUTOS (PRINT 4 E 5) --- */}
        <section className="mb-20">
           ...
           <div className="grid grid-cols-1 md:grid-cols-2 gap-10 max-w-4xl mx-auto">
              <div className="bg-[#0f172a] border border-cyan-500/20 p-10 rounded-[3rem] text-center shadow-xl">
                 ...
                 <button onClick={()=>window.open('https://blockchain-betbrasil.io/pt/inter-bet')} className="w-full bg-cyan-500 text-black py-4 rounded-[2rem] font-black text-[10px] uppercase">Acessar Site</button>
              </div>
              <div className="bg-[#0f172a] border border-cyan-500/20 p-10 rounded-[3rem] text-center shadow-xl">
                 ...
                 <button onClick={()=>window.open('https://blockchain-betbrasil.io/pt/quina-bet')} className="w-full bg-cyan-500 text-black py-4 rounded-[2rem] font-black text-[10px] uppercase">Acessar Site</button>
              </div>
           </div>
        </section>
...
console.log("✅ Dashboard ORIGINAL restaurado com fidelidade total!");