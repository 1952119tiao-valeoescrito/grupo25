  ...
  return (
    <div className="min-h-screen bg-[#010409] text-white font-sans overflow-x-hidden relative selection:bg-cyan-500/30">
      ...
      <main className="max-w-6xl mx-auto px-4 md:px-6 py-10 text-center relative z-10">
        ...
        {/* 1. TOPO DO SCROLL: CARDS PRODUTOS (INTER-BET / QUINA-BET) */}
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12 max-w-5xl mx-auto px-4">
          <div className="bg-[#0f172a]/95 border border-cyan-500/30 p-10 rounded-[3.5rem] shadow-2xl text-center">
             ...
             <p className="text-[10px] text-white font-bold mb-6">GANHA COM ATÉ 1 PONTO</p>
        ...
        {/* 2. MEIO DO SCROLL: PORTAL DE ACESSO E CRÉDITO */}
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-16 max-w-5xl mx-auto items-stretch">
            <div className="bg-[#0f172a]/95 border border-cyan-500/30 p-10 rounded-[3.5rem] shadow-2xl text-left backdrop-blur-md">
               ...
               <div className="space-y-4">
                  ...
                  <button onClick={()=>alert("Matrix Ativada")} className="w-full bg-cyan-700 p-5 rounded-2xl font-black text-xs uppercase shadow-lg">ACESSAR MATRIX</button>
               </div>
            </div>
        ...
        {/* 4. BASE DO SCROLL: MALHA MATRIX E COLUNA DIREITA */}
        <div className="grid lg:grid-cols-3 gap-8 items-start text-left mb-20">
          ...
          <div className="space-y-6">
            <div className="bg-[#0f172a] border border-amber-500/30 p-8 rounded-[2.5rem] shadow-2xl relative overflow-hidden text-left">
...
console.log("✅ DASHBOARD REESTRUTURADO COM SUCESSO! 100% FIEL AOS PRINTS.");